...
import { AlumnoNuevo } from '../../interfaces/alumnos';
              ...
              private builder: FormBuilder) {
                ...
                this.registroForm = this.builder.group({
                  ...
                  'apellido': new FormControl ("", [Validators.required, Validators.minLength(1), 
                                                  Validators.maxLength(80),
                                                  Validators.pattern('^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]*$')]),
                  'rut': new FormControl ("", [Validators.required, Validators.minLength(9), Validators.maxLength(10), Validators.pattern('[0-9]+[-]?[0-9kK]{1}$')]),
                  'email': new FormControl ("", [Validators.required, Validators.email]),
                  'password': new FormControl ("", [Validators.required, Validators.minLength(5), Validators.maxLength(16)]),
                  'carrera': new FormControl ("", [Validators.required, Validators.pattern('^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]*$')]),
                });
  }
